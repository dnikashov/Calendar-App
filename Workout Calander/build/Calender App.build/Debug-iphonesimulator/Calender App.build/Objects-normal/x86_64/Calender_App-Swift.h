...
#ifndef CALENDER_APP_SWIFT_H
#define CALENDER_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Calender_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12Calender_App11AppDelegate")
...
SWIFT_CLASS("_TtC12Calender_App12CalendarCell")
@interface CalendarCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified dayOfMonth;
...
SWIFT_CLASS("_TtC12Calender_App13SceneDelegate")
...
SWIFT_CLASS("_TtC12Calender_App20SecondViewController")
...
SWIFT_CLASS("_TtC12Calender_App14ViewController")
...
- (IBAction)prevMonth:(id _Nonnull)sender;
